...
- (void)testAutomaticRedirection
{
	...
	for (i=301; i<308; i++) {
		...
		success = [[request responseString] isEqualToString:[NSString stringWithFormat:@"Non-redirected content with %i status code",i]];
		GHAssertTrue(success,[NSString stringWithFormat:@"Got the wrong content when not redirecting after a %i",i]);
		...
		NSString *expectedString = [NSString stringWithFormat:@"Redirected as %@ after a %i status code",method,i];
		if (i>304) {
		...
		GHAssertTrue(success,[NSString stringWithFormat:@"Got the wrong content when redirecting after a %i",i]);
	...
	for (i=301; i<303; i++) {
		...
		if (i == 303) {
			...
			success = [[request2 responseString] isEqualToString:[NSString stringWithFormat:@"Redirected as GET after a %i status code",i]];
			...
			success = ([[request2 responseString] isEqualToString:[NSString stringWithFormat:@"Redirected as POST after a %i status code\r\nWatch out for the Giant Monkey!",i]]);
