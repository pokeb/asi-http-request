...
*Updated Fork for the discontinued ASIHTTPRequest project*

Use it by adding `pod 'ASIHTTPRequest', :git => 'https://github.com/codelathe/asi-http-request.git'` to their Podfile.

Pull request to the original repository https://github.com/pokeb/asi-http-request/pull/412.
...
ASIHTTPRequest is compatible with Mac OS 10.6 or later, and iOS 8.0 or later.
